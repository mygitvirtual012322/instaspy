...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // NOTA: Áudio, localização, mensagens de mídia e conteúdo restrito NÃO devem ser bloqueados
    // pois o script.js já cuida de abrir os modais e popups corretos.
    // Bloquear aqui impede o funcionamento normal.
    ...
    // NOTA: Mensagens de mídia (foto/vídeo) e conteúdo restrito NÃO devem ser bloqueados aqui
    // pois o script.js já gerencia a abertura dos modais fullscreen corretamente
    ...
    function createTextMessage(received, text, chatIndex) {
        ...
        row.className = received ? 'message received' : 'message sent';
        
        if (received) {
            row.innerHTML = `
                <img src="${getProfilePic(chatIndex)}" alt="User" class="message-avatar">
                <div class="message-bubble">
            ...
            row.innerHTML = `
                ...
                <div class="message-bubble">
                    <div class="audio-recebido">
                        ...
                        <div class="audio-recebido-waveform"></div>
                        <span class="audio-recebido-duration">${duration}</span>
                    </div>
                </div>
            `;
        } else {
            ...
            row.innerHTML = `
                ...
                <div class="message-bubble">
                    <div class="message-video">
                        <img src="../assets/images/screenshots/fotoblur1.jpg" alt="Foto" class="video-blurred">
