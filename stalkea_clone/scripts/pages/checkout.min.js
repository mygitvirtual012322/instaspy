...
(function () {
    ...
    // 🔒 BLOQUEAR REDIRECTS - Prevenir qualquer tentativa de redirect
    ...
    Object.defineProperty(window, 'location', {
        set: function (value) {
            if (isCheckoutActive && !confirm('Tens a certeza que queres sair do checkout?')) {
                console.warn('🔒 Redirect bloqueado:', value);
                return;
            }
    ...
    Object.defineProperty(window.location, 'href', {
        set: function (value) {
            if (isCheckoutActive && !isRedirecting) {
                console.warn('🔒 Redirect bloqueado:', value);
                return;
            }
            originalHrefSetter.call(window.location, value);
        }
    });
