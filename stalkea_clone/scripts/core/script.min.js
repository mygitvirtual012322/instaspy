...
function loadOlderMessages() {
    ...
    if (messagesLoadCount >= 3) {
        ...
        showBlockedPopup("Seja um membro VIP do InstaSpy<br>para carregar mais mensagens");
        return;
    }
...
function sendAudioMessage() {
    ...
    playBtnSent.addEventListener('click', function() {
        ...
        if (icon.classList.contains('fa-play')) {
            ...
            // Mostrar popup VIP imediatamente
            showAudioVIPPopup();
            
            // Atualizar transcrição em background (se houver)
...
document.addEventListener('click', function(e) {
    ...
    if (container && blurredImg) {
        ...
        if (alreadyViewed) {
            showBlockedPopup("Seja um membro VIP do InstaSpy<br>para poder rever as imagens do chat");
            return;
        }
...
const blockedMessages = {
    default: "Seja um membro VIP do InstaSpy<br>para poder interagir nas conversas",
    input: "Seja um membro VIP do InstaSpy<br>para enviar mídias e arquivos",
    location: "Seja um membro VIP do InstaSpy<br>para visualizar localizações",
    call: "Seja um membro VIP do InstaSpy<br>para fazer chamadas",
    profile: "Seja um membro VIP do InstaSpy<br>para visualizar perfis",
    reply: "Seja um membro VIP do InstaSpy<br>para responder mensagens",
    cancel: "Seja um membro VIP do InstaSpy<br>para cancelar envios"
};
